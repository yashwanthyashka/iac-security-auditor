"""Deterministic grader for Terraform audit submissions."""
...
try:
    from .benchmark_data import AuditTask, ExpectedFinding
except ImportError:
    from benchmark_data import AuditTask, ExpectedFinding
...
def _best_finding_score(predicted_findings: list[dict[str, Any]], expected: ExpectedFinding) -> float:
    best = 0.0
...
def grade_submission(task: AuditTask, report_json: str) -> GradeResult:
    """Grade a submission and map the final score into the open interval (0, 1)."""
